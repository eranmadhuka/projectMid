        ...
        <>
            <div>
                <div className='flex items-center justify-between'>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Recent Notification
                    </h3>
                    <a href="#" className='text-customBlue font-medium'>View All</a>
                </div>
                <div className='divide-y mt-5 divide-gray-100 dark:divide-gray-700'>
                    ...
                    <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                        <div className="flex-shrink-0">
                            <img className="rounded-full w-11 h-11 object-cover" src={Avatar} alt="Joseph image" />
